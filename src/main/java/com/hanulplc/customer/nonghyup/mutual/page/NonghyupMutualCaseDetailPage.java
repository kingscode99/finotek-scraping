...
@Slf4j
public class NonghyupMutualCaseDetailPage {
    ...
    public void navigateToFirstTab() {
        ...
        $("#applDto > div:nth-child(42) > h3").shouldBe(visible);
        // =======================================================
    }
    ...
    public Map<String, String> 등기_의뢰_정보(String caseManagementNumber) {
        ...
        String 담당자명 = $("#applDto > div:nth-child(42) > table > tbody > tr:nth-child(2) > td:nth-child(2) > input").getValue();
        String 담당자_연락처 = $("#reqBrPsnPhone").getValue();
        String 담당자_팩스번호 = $("#applDto > div:nth-child(42) > table > tbody > tr:nth-child(2) > td:nth-child(6) > input").getValue();
        ...
        caseBasicInfo.put("ACCNT_CD", "NHS");
    ...
    public Map<String, String> 등기_상세_정보() {
        String 전자등기구분1 = $("#rgst_knd_nm").getValue();
        String 전자등기구분2 = $("#appl_knd_nm").getValue();
        String 등기유형 = $("#applDto > div:nth-child(43) > table > tbody > tr:nth-child(1) > td:nth-child(4) > input.readonly.ip_03").getValue();
        ...
        String 채권최고액 = $("#applDto > div:nth-child(43) > table > tbody > tr:nth-child(3) > td:nth-child(2) > input.price.readonly").getValue();
        String 농업인_축산인_여부 = $("#applDto > div:nth-child(43) > table > tbody > tr:nth-child(3) > td:nth-child(4) > input").getValue();

        log.info("전자등기구분1 = {}", 전자등기구분1);
        log.info("전자등기구분2 = {}", 전자등기구분2);
        ...
        log.info("농업인 축산인 여부 = {}", 농업인_축산인_여부);

        String registrationTypeCode = 전자등기구분2.equals("일반") ? "20" : "10";
        ...
        caseDetailInfo.put("RGSTRN_TYP_DETAIL", 전자등기구분2.equals("일반") ? "21" : "22");
        caseDetailInfo.put("RGSTRN_TYP_SUB_CD", "2001");
        caseDetailInfo.put("CO_CASE_YN", "N"); // 20:
        ...
        caseDetailInfo.put("TAX_EXE_YN", 농업인_축산인_여부.equals("-") ? "N" : "Y");
    ...
    public List<Map<String, String>> 담보제공자_정보(String caseManagementNumber) {
        ...
        for (SelenideElement securityProvider : securityProviders) {
            ...
            String 담보제공자_구분 = $("#oblg_clss").getText();
            String 초본_발급확인번호 = $("#cert_issue_num").getValue();
            String 초본_발급일자 = $("#cert_issue_date").getValue();
            ...
            String 서명방식 = $("#tr_3_2810 > td:nth-child(4) > input").getValue();
            ...
            log.info("담보제공자 구분 = {}", 담보제공자_구분);
            log.info("초본 발급확인번호 = {}", 초본_발급확인번호);
            log.info("초본 발급일자 = {}", 초본_발급일자);
